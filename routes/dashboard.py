...
def index():
    ...
    for t in transactions:
        t.display_amount = converter.convert(t.amount, "GEL", user_currency)
...
def add_transaction():
    ...
    user_currency = current_user.currency or "GEL"  
    final_amount = converter.convert(amount, tx_currency, "GEL")
    ...
    db.session.commit()
    display_final = converter.convert(amount, tx_currency, user_currency)
